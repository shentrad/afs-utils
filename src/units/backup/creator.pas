...
begin
  //Adding a directory
  SelectDirectoryDialog1.Title := 'Add files of this directory...';
...
begin
  SelectDirectoryDialog1.Title := 'Mass create from...';
  if SelectDirectoryDialog1.Execute then begin
    QueueMassCreation(SelectDirectoryDialog1.FileName);
  end;
end;
